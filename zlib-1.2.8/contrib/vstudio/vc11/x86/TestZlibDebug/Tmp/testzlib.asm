; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	D:\vs_project\zlib-1.2.8\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG87068 DB	'rb', 00H
	ORG $+5
$SG87099 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG87101 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG87103 DB	'file %s read, %u bytes', 0aH, 00H
$SG87117 DB	'1.2.8', 00H
	ORG $+2
$SG87122 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG87124 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG87126 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG87127 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG87138 DB	'1.2.8', 00H
	ORG $+2
$SG87143 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG87145 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG87147 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG87148 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG87151 DB	'compare ok', 0aH, 00H
_DATA	ENDS
...
; File d:\vs_project\zlib-1.2.8\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
